...
dirname = os.path.join(os.getcwd(),'C:\\Users\\gilba\\Desktop\\IA\\DataSetFlores')
...
INIT_LR = 1e-3 # Valor inicial de learning rate. El valor 1e-3 co0rresponde con 0.001
epochs = 5 # Cantidad de iteraciones completas al conjunto de imagenes de entrenamiento
...
letras_model.save("C:\\Users\\gilba\\Desktop\\IA\\ProyectoFinal\\Flores\\floresAux.h5py")
